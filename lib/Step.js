  ...
  _createClass(Step, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: styles.step, className: 'stepper-container ' + (active || completed ? 'active' : '') },
        _react2.default.createElement(
          'div',
          { style: circleStyle, className: 'stepper-element' },
          active || completed ? _react2.default.createElement(
            'a',
            { href: href, onClick: onClick, style: styles.index, className: 'stepper-number active' },
            stepContent
          ) : _react2.default.createElement(
            'span',
            { style: styles.index, className: 'stepper-number' },
            stepContent
          )
        ),
        active || completed ? _react2.default.createElement(
          'a',
          { href: href, onClick: onClick, style: titleStyle, className: 'stepper-number active' },
          title
        ) : _react2.default.createElement(
          'div',
          { style: titleStyle, className: 'stepper-number' },
          title
        ),
        !first && _react2.default.createElement('div', { style: leftStyle, className: 'stepper-left-line' }),
        !isLast && _react2.default.createElement('div', { style: rightStyle, className: 'stepper-right-line' })
      );
    }
  }]);
